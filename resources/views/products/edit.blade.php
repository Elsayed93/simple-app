      ...
      <form action="{{ route('products.update', '$product->id') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input name="{{ $input }}" type="text" class="form-control @error($input) is-invalid @enderror"
            id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="product {{ $input }}" value="">
        ...
        <div class="form-group">
          ...
          <input type="text" name="{{ $input }}" class="form-control @error($input) is-invalid @enderror"
            id="exampleInputPassword1" placeholder="{{ $input }}" value="">
        ...
        <div class="form-group">
          ...
          <textarea class="@error($input) is-invalid @enderror" name="{{ $input }}" id="exampleInputPassword1"
            style="width: 100%" rows="7" placeholder="{{ $input }}"></textarea>
          @error($input)
            <div id="validationServerUsernameFeedback" class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <button type="submit" class="btn btn-primary">Update {{ ucfirst($product) }}</button>
      </form>
